output "workspace_id" {
  ...
  value       = azurerm_databricks_workspace.sales.workspace_id
}
...
output "workspace_url" {
  ...
  value       = azurerm_databricks_workspace.sales.workspace_url
}
...
output "access_connector_id" {
  ...
  value       = azurerm_databricks_access_connector.sales.id
}
...
output "managed_resource_group_id" {
  ...
  value       = azurerm_databricks_workspace.sales.managed_resource_group_id
}
